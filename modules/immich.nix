...
in {
  options.services.my-immich = {
    ...
    settingsFile = mkOption {
      ...
      example = "/run/secrets/rendered/immich.json";
    };
  ...
  config = mkIf cfg.enable {
    ...
    services.my-immich.environment = let
      postgresEnv =
    ...
    in
      ...
      // lib.optionalAttrs (cfg.settingsFile != null) {
        IMMICH_CONFIG_FILE = "${cfg.settingsFile}";
      };

    services.my-immich.machine-learning.environment = {
